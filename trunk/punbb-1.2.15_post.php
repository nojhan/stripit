...
if ($ttitle != '') {
	...
	// if the topic exists, consider that tid is set, else, consider that this is a new one
	if( $_tid ) {
		$tid = $_tid;
		
		// the topic exists, so that we must not consider the forum
		$fid = 0;
	} else {
